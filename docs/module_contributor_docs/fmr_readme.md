...
See the [module contributor docs](./draft_contrib_instructions.md) for a full schema reference and guide to writing or updating a module YAML.
...
See the [module contributor docs](./draft_contrib_instructions.md) for the full YAML schema and validation guidance.
